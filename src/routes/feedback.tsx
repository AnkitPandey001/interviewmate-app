...
import { Interviews as Interview , UserAnswer } from "../types/index";
...
export const Feedback = () => {
  ...
  return (
    <div className="w-full px-4 md:px-10 lg:px-20 py-5 flex flex-col gap-8">
      ...
      {interview && <InterviewsPin data={interview} onMockPage /> }
